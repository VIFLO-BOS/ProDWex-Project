...
function CreateWhatsappChatWidget(
	...
	let url =
		"https://extension-us.us-west-1.log.aliyuncs.com/logstores/scrm-web/track?APIVersion=0.6.0";
	let strData =
		"&event_type=600003" +
		"&host=" +
	...
	function initWidget() {
		...
		jQuery("body").append(`<div id="whatsapp_chat_widget">
            <div class="whatsapp-icons" id="wa-widget-send-button">
		...
		jQuery("#whatsapp_chat_widget").append(`
			...
			option.brandSetting.messageText
				...
				: ""
                     ...
                     <div class='wa-chat-box-poweredby'></div>
                </div>
            </div>
        `);
